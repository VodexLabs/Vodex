...
must(route, "verifiedCount", "verified count in response", errors);
must(route, "visibleToOwner", "owner visibility check", errors);
must(route, "resolveBroadcastRecipientIds", "owner always included", errors);
