  ...
  return (
    <footer className="border-t border-white/10 bg-[#080c18]/90">
      ...
      <p className="pb-6 text-center text-[10px] text-slate-500">
        © {new Date().getFullYear()} {name}. Crafted with Vodex.
      </p>
    </footer>
  );
}
...
This project is a Next.js portfolio generated by Vodex. It includes an animated hero, project showcase,
...
Vodex enforces meaningful file sizes and real section content — not placeholder routes. Each component
