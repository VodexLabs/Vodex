...
export const RUNTIME_ACTION_CATALOG = {
  ...
  llm_generation_standard: { floor: 5, label: "LLM generation standard", category: "llm" },
  ...
  image_standard: { floor: 3, label: "Image standard", category: "image" },
  image_premium: { floor: 10, label: "Image premium (add-on only)", category: "image" },
  image_edit: { floor: 10, label: "Image edit (add-on only)", category: "image" },
  ...
  app_icon_ai_generation: { floor: 3, label: "AI app icon", category: "image" },
  app_logo_generation: { floor: 4, label: "App logo generation", category: "image" },
  app_logo_regeneration: { floor: 4, label: "App logo regeneration", category: "image" },
