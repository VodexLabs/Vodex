...
export const RUNTIME_ACTION_CATALOG = {
  ...
  webhook_call: { floor: 0.5, label: "Webhook call", category: "automation" },
  automation_run: { floor: 0.5, label: "Automation run", category: "automation" },
  automation_run_basic: { floor: 0.5, label: "Automation run (basic)", category: "automation" },
  file_upload: { floor: 0.5, label: "File upload", category: "file" },
  file_processing: { floor: 1, label: "File processing", category: "file" },
  data_extraction: { floor: 2, label: "Data extraction", category: "file" },
  email_send: { floor: 0.5, label: "Email send (legacy)", category: "email" },
  email_send_basic: { floor: 0.5, label: "Email send (basic)", category: "email" },
  email_send_notification: { floor: 0.5, label: "Email notification", category: "email" },
  email_send_transactional: { floor: 1, label: "Transactional email", category: "email" },
  email_bulk_or_sequence: { floor: 2, label: "Bulk/sequence email", category: "email" },
  llm_micro: { floor: 0.5, label: "LLM micro", category: "llm" },
  llm_small: { floor: 1, label: "LLM small", category: "llm" },
  llm_main: { floor: 3, label: "LLM main", category: "llm" },
  llm_generation: { floor: 6, label: "LLM generation (legacy)", category: "llm" },
  llm_generation_simple: { floor: 4, label: "LLM generation simple", category: "llm" },
  llm_generation_standard: { floor: 6, label: "LLM generation standard", category: "llm" },
  llm_generation_advanced: { floor: 10, label: "LLM generation advanced", category: "llm" },
  ai_agent_step: { floor: 3, label: "AI agent step", category: "llm" },
  ai_agent_message: { floor: 3, label: "AI agent message", category: "llm" },
  ai_workflow_step: { floor: 3, label: "AI workflow step", category: "llm" },
  image_generation: { floor: 4, label: "Image generation (legacy)", category: "image" },
  image_simple: { floor: 2, label: "Image simple", category: "image" },
  image_standard: { floor: 4, label: "Image standard", category: "image" },
  image_premium: { floor: 8, label: "Image premium", category: "image" },
  image_edit: { floor: 10, label: "Image edit", category: "image" },
  ...
  video_generation: { floor: 15, label: "Video generation", category: "media" },
  ...
  android_build: { floor: 2, label: "Android cloud build", category: "mobile" },
  ios_build: { floor: 3, label: "iOS cloud build", category: "mobile" },
  mobile_artifact_storage: { floor: 0.5, label: "Mobile artifact storage", category: "mobile" },
  app_icon_ai_generation: { floor: 2, label: "AI app icon", category: "image" },
  app_logo_generation: { floor: 0.5, label: "App logo generation", category: "image" },
  app_logo_regeneration: { floor: 0.5, label: "App logo regeneration", category: "image" },
