  ...
  return (
    <div className="relative mx-auto max-w-3xl">
      ...
      <motion.div variants={variants.fadeUp} initial="hidden" animate="show" className="relative flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-[14px] text-muted-foreground">
            Major updates, improvements, and fixes — shipped regularly.
          </p>
        </div>
      ...
      <div className="relative mt-12 pl-4">
        {/* Timeline line */}
        <div className="absolute left-0 top-2 bottom-4 w-px bg-border" />
      ...
      <motion.div variants={variants.fadeUp} initial="hidden" animate="show" transition={{ delay: 0.4 }} className="relative mt-12 rounded-[var(--radius-xl)] bg-gradient-to-br from-accent/6 to-transparent p-6 text-center ring-1 ring-accent/15">
        ...
        <div className="mt-3 flex flex-wrap justify-center gap-2">
          {["Live collaboration cursors", "Custom model fine-tuning", "App store publishing", "AI design assistant", "Voice-to-app"].map((feature) => (
